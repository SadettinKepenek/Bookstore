...
public class CompleteTests
{
    ...
    [Fact]
    public async Task CompleteOrderAsync_ValidOrder_ShouldCompleteOrder()
    {
        // Arrange
    ...
    [Fact]
    public async Task CompleteOrderAsync_OrderNotFound_ShouldThrowNotFoundException()
    {
        // Arrange
        var orderId = Guid.NewGuid();
        ...
        // Act
        var action = async () => await _orderService.CompleteOrderAsync(orderId, CancellationToken.None);
